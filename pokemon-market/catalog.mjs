import { normalizeSearchText, searchTextForCard } from "./core.mjs?v=8";
...
export function mergeCatalogGroups(localGroups, remoteCards) {
  ...
  for (const group of groupCatalogCards(remoteCards)) {
    ...
    if (existing) {
      ...
      existing.primary = {
        ...existing.primary,
        setName: remotePrimary.setName || existing.primary.setName,
        rarity: remotePrimary.rarity || existing.primary.rarity,
